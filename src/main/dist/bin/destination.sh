...
DEFAULT_JVM_OPTS="$DEFAULT_JVM_OPTS -XX:+ScavengeBeforeFullGC"
DEFAULT_JVM_OPTS="$DEFAULT_JVM_OPTS -XX:+CMSScavengeBeforeRemark"
#DEFAULT_JVM_OPTS="$DEFAULT_JVM_OPTS -XX:MaxNewSize=2g -XX:NewSize=2g"
...
${JAVACMD} ${DEFAULT_JVM_OPTS} -classpath ${CLASSPATH} io.pivotal.gemfire.demo.Destination "$@"
